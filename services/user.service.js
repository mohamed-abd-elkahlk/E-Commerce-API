...
const { issueJWT, genHash } = require("../utils/auth.utiles");
...
exports.changeUserPassword = asyncHandler(async (req, res, next) => {
  const createNewPassword = genHash(req.body.password);
  const document = await User.findByIdAndUpdate(
    req.params.id,
    {
      password: createNewPassword.hash,
      salt: createNewPassword.slat,
